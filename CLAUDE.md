...
| `docs/AUDIT-2026-08.md` | a 26-agent review of where the code and tools mislead — a snapshot, kept for its reasoning; its top three have landed, so read `TODO.md` for the order |
