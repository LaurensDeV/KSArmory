...
public static class Arsenal
{
    ...
    public static readonly IReadOnlyList<LauncherProfile> Launchers = [PantsirS1, SidewinderRail, Ciws];
    public static readonly IReadOnlyList<MunitionProfile> Munitions = [Missile57E6, Cannon30Mm, Missile9J, Cannon20Mm];
    public static readonly IReadOnlyList<SensorProfile> Sensors = [SearchRadar1Rs1, SeekerHeadAim9, SearchRadarVps2];
