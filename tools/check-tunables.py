...
EXEMPT = {
    ...
    "SensorProfile.Scope":
        "what picture the set puts in front of the operator is what kind of instrument it is -- "
        "a seeker head has none and an anti-radiation seeker's is a list of emitters, and neither "
        "becomes the other because somebody ticked a box",
    ...
    "MunitionProfile.PreferredStepSeconds":
        "what the round would rather the world ran at -- a property of the round, and one a player "
        "lowering would spend their own clock rather than buy anything they can see",
